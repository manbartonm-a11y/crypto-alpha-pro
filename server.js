...
app.get('/telegram', async (req, res) => {
  ...
  if (!isPremium) {
    ...
    res.write("<div class='btn' onclick=\"stripe.redirectToCheckout({lineItems:[{price:'price_1I1g6RGrBtr1rroC4b9p8q9r',quantity:1}],mode:'subscription',successUrl:location.href+'?id=777000',cancelUrl:location.href})\">Pay with Card / PayPal / Apple Pay</div>");
  } else {
