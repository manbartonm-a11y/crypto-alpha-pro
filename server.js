...
const PRICE_ID = "prod_TYMpSYYnpnP7EI"; // ? this is correct for your product

// Store paid users (Telegram userId = Telegram ID
...
// Fake whale every 30 sec (replace with real later)
...
setInterval(() => {
  ...
  sendPush(lastWhale); // ? NOW REALLY SENDS DMs
}, 30000);
...
// AFTER SUCCESSFUL PAYMENT — ADD USER TO PREMIUM
app.post('/webhook', express.raw({type: 'application/json'}), (req, res) => {
  // Stripe webhook — you can add real validation later
  const userId = "777000"; // test
