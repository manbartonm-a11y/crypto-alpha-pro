...
const PREMIUM = new Set(); // user IDs
...
app.get("/telegram", (req,res)=>{
  ...
  if (isPremium && PORTFOLIOS[userId]) {
    ...
    pnlBox = `<div style="background:#001a00;padding:50px;border:14px solid ${color};border-radius:70px;margin:70px auto;max-width:950px;font-size:5em;color:${color};box-shadow:0 0 180px ${color}">
