...
app.get('/telegram', async (req, res) => {
  ...
  res.write(`<div style="background:#001a00;padding:20px;border:3px solid #0f0;border-radius:20px;margin:20px;font-size:1.5em${isPremium?'':' class="blur"'}">WHALE ALERT $42.7M BTC to Binance (3 min ago)</div>`);
  ...
  if (!isPremium) {
    ...
    res.write('<div class="btn" onclick="location.href=\'https://buy.stripe.com/00wdR92NcfZzdNgahlgEg00\'">Pay with Card / PayPal / Apple Pay</div>');
  } else {
