...
<head>
  ...
  <style>
    ...
    .btn{background:linear-gradient(45deg,#00d4ff,#8b00ff);color:#fff;padding:20px 40px;font-size:2em;border-radius:20px;cursor:pointer;margin:15px auto;width:90%;max-width:500px;box-shadow:0 0 20px rgba(0,212,255,0.5)}
  </style>
