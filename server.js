...
app.get('/telegram', (req, res) => {
  ...
  res.write('.box{background:#000;padding:25px;border:2px solid #0f0;border-radius:35px;margin:25px auto;max-width:750px;font-size:1.9em;box-shadow:0 0 50px #0f0}</style></head><body>');
  res.write('<h1>CRYPTO ALPHA PRO</h1>');
  res.write('<div class="p" id="price">,167</div>');
  res.write('<div id="change" style="font-size:4em;color:#0f0">24h +?.??%</div>');
  ...
  res.write('});},5000);</script></body></html>');
  res.end();
});
