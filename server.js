...
// Keep Render awake + instant response
app.get("/", (req, res) => res.send("Crypto Alpha Pro is LIVE! ??"));
...
<div class="p" id="price">Loading price...</div>
...
<script>
  ...
  async function load(){
    ...
    } catch(e) { document.body.innerHTML += "<p style=color:#f66>API rate limit — retry in 30s</p>"; }
  }
...
app.listen(PORT, () => console.log(\`Live on https://crypto-alpha-pro.onrender.com\`));
