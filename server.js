...
app.get('/telegram', (req, res) => {
  ...
  res.write('<style>body{margin:0;background:#000;color:#0f0;font-family:monospace;text-align:center;padding:20px}h1{color:#0ff;font-size:3.5em;text-shadow:0 0 30px #0ff}.p{font-size:5.5em;color:#0f9;margin:10px;text-shadow:0 0 40px #0f9}canvas{width:95%;max-width:600px;height:280px;border:6px solid #0f0;border-radius:20px;margin:30px auto;background:#000;box-shadow:0 0 60px #0f0}.box{background:#001a00;padding:20px;border:3px solid #0f0;border-radius:20px;margin:20px;font-size:1.5em;box-shadow:0 0 40px #0f0}.btn{background:#0f0;color:#000;padding:20px 80px;border-radius:50px;font-size:2em;text-decoration:none;display:inline-block;margin:40px;box-shadow:0 0 50px #0f0;letter-spacing:2px;font-weight:bold}.live{animation:glow 2s infinite}@keyframes glow{0%,100%{text-shadow:0 0 20px #0f0}50%{text-shadow:0 0 50px #0f0}}</style></head><body>');
  ...
  res.write('<div class="box live">WHALE ALERT .7M BTC ? Binance (3 min ago)</div>');
...
app.listen(PORT, '0.0.0.0', () => console.log('Crypto Alpha Pro LIVE on Render!'));
